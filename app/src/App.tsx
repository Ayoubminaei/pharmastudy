...
function App() {
  ...
  if (isInitializing) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#f7f9fa] to-white dark:from-gray-900 dark:to-gray-800">
        <div className="text-center">
          <div className="w-16 h-16 border-4 border-[#0070a0] border-t-transparent rounded-full animate-spin mx-auto mb-4" />
          <p className="text-[#626a72] dark:text-gray-400">Loading...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f7f9fa] to-white dark:from-gray-900 dark:to-gray-800 molecular-bg transition-colors duration-300">
      <Toaster 
        position="top-right" 
        richColors 
        closeButton
