...
export default function Items() {
  const { user, selectedChapter, selectedTopic, setSelectedTopic, setCurrentView, setSelectedItem, selectedItem } = useStore();
  ...
  const handleViewItem = (item: StudyItem) => {
                ...
                {filteredItems.map((item) => {
                  ...
                  return (
                    <div
                      ...
                      className="item-card group bg-white dark:bg-gray-800 rounded-2xl shadow-lg shadow-black/5 overflow-hidden hover-lift border border-transparent hover:border-[#0070a0]/20 cursor-pointer"
                    >
                      {/* Image */}
